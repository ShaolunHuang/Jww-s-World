...
Last README file update: Sat Jul 19 23:34:22 EDT 2025
...
command.fast_tpa
command.fast_tpa.broadcast
command.fast_tpa.broadcast.value
command.fast_tpa.cooldown
command.fast_tpa.cooldown.value
command.fast_tpa_tp
command.fast_tpa_tp.other
command.fast_tpa_tp.other.self
command.feed
command.feed.target
command.fill
command.fill.from
